...
$uid=$_SESSION['uid'];
$sql = "SELECT * FROM orders, orders_detail WHERE orders.order_id=orders_detail.order_id AND orders_detail.sen_uid ='0'  GROUP BY orders_detail.shop_id";
                ...
                <div class="card-body">
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><a href="action.php?accept=<?= $data['shop_id'];?>&deid=<?= $uid;?>" onClick="return confirm('คุณต้องการรับรายการนี้ใช่มั้ย');">รับรายการ</a></td>
