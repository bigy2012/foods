    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h5 class="modal-title w-100 text-primary">สมัครสมาชิก ระบบสั่งจองอาหารออนไลน์</h5>
            ...
            <div class="modal-body p-3 w-100">
                <form action="user_insert.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-block w-100 text-center">
                        ...
                        <div class="mt-3 mb-3 row">
                            <label class="col-md-3 col-sm-3 col-form-label text-end">ประเภทสมาชิก :</label>
                            <div class="col-md-8 col-sm-8">
                                <select name="role" class="form-select mb-1 mr-sm-1">
                                    <?php
                                $role=array('ผู้ดูแลร้านอาหาร','ผู้ส่งอาหาร','ลูกค้าหรือสมาชิก'); 
                                foreach($role as $value){ 
                                ?>
                                    <option value="<?php echo $value; ?>" <?php if (!(strcmp($value, $value))) {
                        ...
                        <label class="col-md-3 col-sm-3 col-form-label text-end"></label>
                            <div class="col-md-8 col-sm-8">
                                ...
                                <button type="submit" class="btn btn-lg btn-primary w-100">สมัครสมาชิก</button>
                            </div>
                        </div>
                    </div>
                </form>
