...
$sql = "SELECT * FROM shop, shop_type, users WHERE shop.shtype_id=shop_type.shtype_id and shop.uid=users.uid";
                        ...
                        <div class="card-body">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td> <?= $data['approve'];  ?>  </td>                                                                                                          
                                    <td>
                                        [<a href="#" data-bs-toggle="modal" data-bs-target="#viewModal" class="myView"  id="<?=$data['shop_id'];?>"> ดู</a>]
                                        [<a href="#" data-bs-toggle="modal" data-bs-target="#editModal" class="myEdit"  id="<?=$data['shop_id'];?>"> แก้ไข</a>]
                                        [<a href="#" data-bs-toggle="modal" data-bs-target="#delModal" class="myDel"  id="<?=$data['shop_id'];?>"> ลบ</a>]
                                    </td>
                                </tr>
                                <?php
                            $i++;
